    ...
    return (
      <div className="row">
        <div className="col-md-12">
          ...
          <p>Schedule:</p>
          <ul>
            <li>11:00AM - JV Championship</li>
            <li>1:00 PM - Conner T. Lowry Award Ceremony</li>
            <li>1:15 PM - Gold Ball Championship</li>
          </ul>
          <p>
            The Visitors side gate will be open from 10AM to 130PM. Fans can park in the Mother McAuley parking lot if
            they prefer. St. Catherine will be the visiting team for both games and use the Visitors/East sidelines at
            Br. Rice. The Main gate will be open from 10AM to 2PM.
          </p>
          <p>
          ...
          <ul>
            <li>5/6 JV Championship Game: - https://www.youtube.com/watch?v=SHKRXxH23gk</li>
            <li>7/8 Gold Ball Championship Game: - https://www.youtube.com/watch?v=BKICvOAAntE</li>
          </ul>
